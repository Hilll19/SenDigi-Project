            ...
            <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
              ...
              <div className="flex flex-col justify-center">
                <p className="md:text-4xl sm:text-3xl text-2xl font-bold py-2">
                  Time Usage Feature in SenDigi
                </p>
                <p>
                  With the Time Usage feature in SenDigi, we offer a trusted
                  solution for parents to monitor and manage their children's
                  gadget usage in today's digital era. Through our user-friendly
                  platform accessible via both web and mobile devices, we
                  provide extensive access for parents to monitor their
                  children's online activities in real-time. With SenDigi, you
                  can mitigate the risks associated with exposure to
                  inappropriate content, screen addiction, and the perils of
                  gadget dependency. Join us at SenDigi and become part of the
                  initiative to safeguard the digital well-being of the next
                  generation!
                </p>
              </div>
            </div>
          ...
          <div className="w-full bg-white py-16 px-4 rounded-lg">
            <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
              ...
              <ol className="list-decimal pt-8">
                <li>
                  <strong>Comprehensive Parental Monitoring :</strong> The Time
                  Usage feature provides a comprehensive platform accessible via
                  web and mobile devices, empowering parents with robust tools
                  to monitor and control their children's online activities in
                  real-time.
                </li>
                <li>
                  <strong>Flexibility :</strong> Parents gain flexibility with
                  the ability to monitor and control their children's gadget
                  usage across multiple devices, ensuring a seamless experience
                ...
                <li>
                  <strong>Insightful Usage Reports :</strong> The Time Usage
